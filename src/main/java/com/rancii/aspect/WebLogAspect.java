package com.rancii.aspect;

import com.alibaba.fastjson.JSONObject;
import com.rancii.base.MySysUser;
import com.rancii.entity.Log;
import com.rancii.exception.GlobalExceptionHandler;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.rancii.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        com.rancii.annotation.SysLog mylog = method.getAnnotation(com.rancii.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
