...
public class LuceneSearch {
    ...
    public Map<String,Object> search(String[] field, String value,Page page) throws Exception{
        ...
        //查询起始记录位置
        int begin = (int)page.getSize() * ((int)page.getCurrent() - 1) ;
        //查询终止记录位置
        int end = Math.min(begin + (int)page.getSize(), scoreDocs.length);
