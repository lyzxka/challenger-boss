...
public class ExcelUtil {
    ...
    private static void createFont(XSSFWorkbook workbook) {
        ...
        font1.setFontHeightInPoints((short) 15);//字体大小
     ...
     * @throws Exception
     */
    public static XSSFWorkbook exportExcelInfo(List<Map<String,Object>> list,List<ExcelBean> excel,Object object) throws Exception{
        Map<Integer,List<ExcelBean>> map = new LinkedHashMap<>();
        map.put(0,excel);
        String sheetName = "sheet";
        //调用ExcelUtil方法
        XSSFWorkbook xssfWorkbook = ExcelUtil.createExcelFile(object.getClass(), list, map, sheetName);
        return xssfWorkbook;
    }
}
