...
import com.rancii.exception.MyException;
...
public class QiniuFileUtil {
	 ...
	 * @throws IOException
	 */
	public static String upload(MultipartFile file,Map<String,Object> map) throws IOException, NoSuchAlgorithmException {
		Zone z = Zone.zone0();
	 ...
	 * @param imgPath
	 */
	public static void deleteQiniuP(String imgPath,Map<String,Object> map) {
		Zone z = Zone.zone0();
		Configuration config = new Configuration(z);
		Auth auth = Auth.create(map.get("qiniuAccess").toString(), map.get("qiniuKey").toString());
	 ...
	 * @return
	 */
	public static String uploadImageSrc(String src,Map<String,Object> map){
		Zone z = Zone.zone0();
		Configuration config = new Configuration(z);
		Auth auth = Auth.create(map.get("qiniuAccess").toString(), map.get("qiniuKey").toString());
		BucketManager bucketManager = new BucketManager(auth, config);
	 ...
	 * @return
	 */
	public static String uploadLocalImg(String src,Map<String,Object> map) throws IOException, NoSuchAlgorithmException{
		Zone z = Zone.zone0();
		Configuration config = new Configuration(z);
		UploadManager uploadManager = new UploadManager(config);
		Auth auth = Auth.create(map.get("qiniuAccess").toString(), map.get("qiniuKey").toString());
	 ...
	 * @return
	 */
	public static String uploadBase64(String base64,String name,Map<String,Object> map) {
		Zone z = Zone.zone0();
		Configuration config = new Configuration(z);
		UploadManager uploadManager = new UploadManager(config);
		Auth auth = Auth.create(map.get("qiniuAccess").toString(), map.get("qiniuKey").toString());
