...
import com.rancii.dao.UserDao;
import com.rancii.entity.Role;
import com.rancii.entity.User;
import com.rancii.realm.AuthRealm;
import com.rancii.service.UserService;
...
public class UserServiceImpl extends ServiceImpl<UserDao, User> implements UserService {
	 ...
	 * @see com.rancii.service.UserService#findUserByLoginName(java.lang.String)
	 */
	 ...
	 */
	@Override
	public Long findUserRoleByCurrent() {
		...
		Long roleId = baseMapper.selectRoleByUserId(user.getId());
		if (roleId==7L || roleId==8L){
