...
import com.rancii.dao.TableDao;
...
import com.rancii.service.TableService;
import com.rancii.util.Underline2Camel;
...
public class TableServiceImpl implements TableService {
    ...
    public List<TableVO> listAll() {
        return tableDao.listAll(database);
    }

    @Override
    public Integer getTableCount() {
        return tableDao.selectTableCount(database);
    }
    ...
    public Integer existTable(String tableName) {
        ...
        return tableDao.existTable(params);
    }
    ...
    public Page<TableVO> selectTablePage(Page<TableVO> objectPage, Map<String,Object> map) {
        map.put("database",database);
        List<TableVO> list = tableDao.listPage(objectPage,null != map.get("name") ? map.get("name").toString() : "",database);
    ...
    public TableVO detailTable(String name) {
        ...
        map.put("name",name);
        map.put("database",database);
        return tableDao.selectDetailTable(map);
    }
