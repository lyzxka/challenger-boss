...
<body style="background-image:url(${base}/static/images/login_bg.jpg)">
<div id="bg-body"></div>
<div class="login">
    <h1>登录</h1>
    <form class="layui-form" action="${base}/login/main" method="post">
        ...
        <div class="layui-form-item">
            <input type="checkbox" name="rememberMe" id="rememberMe" value="true" lay-skin="primary" checked title="记住帐号?">
        </div>
...
<script type="text/javascript" src="${base}/static/js/jquery.cookie.js"></script>
<script type="text/javascript">
    ...
    function Save() {
        ...
        if ($("#rememberMe").prop("checked")) {
            ...
            $.cookie("rmbUser", "true", { expires: 1096 }); //存储一个带7天期限的cookie
            $.cookie("username", str_username, { expires: 1096 });
            $.cookie("password", str_password, { expires: 1096 });
        }
        else {
...
<script>
    layui.use(['layer', 'form'], function() {
       ...
       /* $(document).ready(function() {
            var srcBgArray = ["images/login_bj.jpg"];
