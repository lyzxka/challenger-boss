...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
                <input  type="text" class="layui-input" value = "${chMatch.matchNo}" name="matchNo"  placeholder="请输入比赛编号">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
                <div id="content">${chMatch.content}</div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
                <input  type="text" class="layui-input" value = "${chMatch.categoryId}" name="categoryId"  placeholder="请输入门类">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
                <input  type="text" class="layui-input" value = "${chMatch.views}" name="views"  placeholder="请输入浏览量">
