...
<body class="main_body kit-theme">
<div class="layui-layout layui-layout-admin kit-layout-admin">
    <!-- 顶部 -->
    <div class="layui-header header">
        <div class="layui-main mag0">
        	<div class="title-sty">
	            <div href="#" class="logo">管理平台</div>
	            <!-- 显示/隐藏菜单 -->
	            <a href="javascript:" class="seraph hideMenu icon-caidan">
	            	<i class="layui-icon layui-icon-shrink-right" style="font-size: 20px; color: #009688;"></i>
	            </a>
	        </div>
            <#--<!-- 搜索 &ndash;&gt;-->
            ...
            <!-- 顶部右侧菜单 -->
            <ul class="layui-nav top_menu kit-nav">
                <#--<li class="layui-nav-item showNotice" id="showNotice" pc>-->
                    <#--<a href="javascript:"><i class="iconfont icon-gonggao"></i><cite>系统公告</cite></a>-->
                <#--</li>-->
                <li class="layui-nav-item" pc>
                    <#--<a href="javascript:" class="mobileAddTab clearCache" data-url="page/user/changePwd.html"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>设置</cite></a>-->
                </li>
                <li class="layui-nav-item lockcms" pc>
                    <a href="${base}/systemLogout" class="signOut icon-lock"><i class="iconfont icon-loginout"></i> 退出</a>
                </li>
                <#--<li class="layui-nav-item lockcms" pc>-->
                ...
                <li class="layui-nav-item" pc>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd pc><a href="javascript:" class="changeSkin"><i class="iconfont icon-huanfu"></i><cite>更换皮肤</cite></a></dd>
                        <dd><a href="${base}/systemLogout" class="signOut"><i class="iconfont icon-loginout"></i><cite>退出</cite></a></dd>
                        <dd><a href="javascript:" class="clearCash"><i class="layui-icon layui-icon-refresh-3"></i><cite>清除缓存</cite></a></dd>
                    </dl>
                </li>
            </ul>
        </div>
    ...
    <!-- 左侧导航 -->
    <div class="layui-side kit-side" style="background-color: #23262E">
