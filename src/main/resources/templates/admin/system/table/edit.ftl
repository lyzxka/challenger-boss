            ...
            <div class="layui-input-block">
                <select name="type" lay-search="" lay-verify="typeCheck" lay-verType="tips" lay-filter="typeFilter">
                    ...
                    <optgroup label="数字类型">
                        ...
                        <option value="DECIMAL" data-default="">DECIMAL(JAVA:BigDecimal)</option>
                    </optgroup>
                    <optgroup label="日期类型">
...
<script>
    ...
    layui.use(['form','jquery','layer','table'],function(){
        ...
        form.on("select(typeFilter)",function (data) {
            ...
            //如果是文本字段
            if(data.value === "TEXT" || data.value === "DECIMAL"){
                $("input[name='length']").attr("disabled","").addClass("layui-disabled");
            ...
            //如果是整形
            if(data.value === "INT" || data.value === "BIGINT" || data.value === "FLOAT" || data.value === "DOUBLE" ){
            ...
            if(obj.event === 'del'){
                ...
                $($("#myform")[0]).find('input,select').each(function () {
                    ...
                    if(name === 'type'){
                        ...
                        //如果是整形
                        if(v === "INT" || v === "BIGINT" || v === "FLOAT" || v === "DOUBLE" ){
                            $("select[name='dofor']").find("option[value='0'],[value='input'],[value='select'],[value='radio'],[value='switch']").removeAttr("disabled");
                        }
                    ...
                    if(name === "length"){
                        $(this).val(data[name]);
                        if(data['type'] === "DATE" || data['type'] === "TIME" || data['type'] === "TIMESTAMP" || data['type'] === "TEXT"){
