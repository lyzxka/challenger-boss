...
layui.use(['bodyTab','form','element','layer','jquery'],function(){
			...
			content : '<div class="skins_box">'+
						'<form class="layui-form">'+
							'<div class="layui-form-item">'+
                                ...
                                '<input type="radio" name="skin" value="粉色" title="粉色" lay-filter="pink">'+
			...
			success : function(index, layero){
				...
				$(".skins_box .layui-form-radio").on("click",function(){
					...
					if($(this).find("span").text() == "橙色"){
						skinColor = "orange";
					}else if($(this).find("span").text() == "绿色"){
                        skinColor = "green";
                    }else if($(this).find("span").text() == "粉色"){
                        skinColor = "pink";
                    }else if($(this).find("span").text() == "蓝色"){
                        skinColor = "blue";
                    }else if($(this).find("span").text() == "红色"){
                        skinColor = "red";
				...
				form.on("submit(changeSkin)",function(data){
					if(data.field.skin != "自定义"){
						if(data.field.skin == "橙色"){
                            ...
                            skinColor = "green";
                        }else if(data.field.skin == "粉色"){
                            skinColor = "pink";
                        }else if(data.field.skin == "蓝色"){
                            skinColor = "blue";
                        }else if(data.field.skin == "红色"){
                            skinColor = "red";
    ...
    $(".clearCash").click(function(){
        $.post("clearUserCash",null,function (res) {
            location.reload();
        });
    });
